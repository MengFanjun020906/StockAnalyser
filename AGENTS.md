...
- 项目定位：StockAnalyser，覆盖 A 股、港股、美股。
...
- 桌面端改动：
  - 适用范围：`apps/dsa-desktop/`、`scripts/run-desktop.ps1`、`scripts/build-desktop*.ps1`、`scripts/build-*.sh`、`docs/deployment/desktop-package.md`
  - 默认执行：先构建 Web，再构建桌面端
