...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "GRAPHITI_EMBEDDING_MODEL": {
        ...
        "description": "Optional Graphiti embedding model. Empty means use the built-in default OpenAI embedding model.",
        "category": "graphiti",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "NEWS_EVENT_SENTINEL_ACTIVE_WINDOWS": {
        ...
        "description": "Local Asia/Shanghai active window string for the news event sentinel, e.g. 08:00-02:30.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
