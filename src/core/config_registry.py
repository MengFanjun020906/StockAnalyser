...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AGENT_REGIME_COMPONENT_TIMEOUT_SECONDS": {
        ...
        "description": "Max seconds for one detect_market_regime component. The default allows one slow market-history fetch while DB cache remains the preferred path.",
        "category": "agent",
        "data_type": "float",
        "ui_control": "number",
        "is_sensitive": False,
