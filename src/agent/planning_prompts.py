...
| 触发条件 | 动作 | 仓位变化 | 价格/仓位目标 | 原因 |
| --- | --- | --- | --- | --- |
| 条件1 | HOLD/ADD/REDUCE/TAKE_PROFIT/STOP_LOSS/WAIT | 维持/降至/加至 | 目标价或目标仓位 | 一句话原因 |
...
| 触发条件 | 动作 | 仓位变化 | 价格/仓位目标 | 原因 |
| --- | --- | --- | --- | --- |
| 条件1 | OPEN/ADD/WAIT/REJECT/MONITOR | 首仓/加仓/不动/放弃 | 入场价或仓位目标 | 一句话原因 |
