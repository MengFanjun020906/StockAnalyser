...
def resolve_tool_etl_profile(tool_name: str) -> str:
    ...
    explicit = {
        ...
        "get_cls_telegraph_news": "news",
        "get_xueqiu_hot_news": "news",
        "get_macro_finance_news": "news",
        "get_market_sentiment_snapshot": "market_regime",
        "get_sentiment_heat_candidates": "candidate_discovery",
        "scan_global_risk_events": "news",
