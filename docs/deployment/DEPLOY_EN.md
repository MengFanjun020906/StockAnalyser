...
This document explains how to deploy the StockAnalyser to a server.
...
git remote add origin https://github.com/your-username/StockAnalyser.git
git branch -M main
...
2. Select **"StockAnalyser Daily Analysis"** workflow
