...
> Related Issue: [#153](https://github.com/MengFanjun020906/StockAnalyser/issues/153)
...
> Related Issue: [#155](https://github.com/MengFanjun020906/StockAnalyser/issues/155)
...
1. **Check the image tag in your deploy command or Compose file**. For example, in `ghcr.io/mengfanjun020906/stockanalyser:v3.12.0`, the deployed version is `v3.12.0`.
2. **If you used `latest`**, check your original `docker pull`, `docker-compose.yml`, or deployment script, then compare with [GitHub Releases](https://github.com/MengFanjun020906/StockAnalyser/releases).
...
2. Search or submit [GitHub Issue](https://github.com/MengFanjun020906/StockAnalyser/issues)
