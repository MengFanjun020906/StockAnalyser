...
class ConfigEnvCompatibilityTestCase(unittest.TestCase):
    ...
    def test_load_from_env_reads_graphiti_config(
        ...
        self.assertTrue(config.news_signal_portfolio_anysearch_enabled)
        self.assertEqual(config.news_signal_portfolio_anysearch_interval_minutes, 300)
        self.assertEqual(config.news_signal_portfolio_anysearch_max_results_per_stock, 5)
        self.assertEqual(config.news_signal_portfolio_anysearch_max_age_days, 21)
        self.assertTrue(config.news_signal_portfolio_anysearch_run_immediately)
        self.assertTrue(config.news_event_sentinel_enabled)
        self.assertEqual(config.news_event_sentinel_interval_minutes, 45)
        self.assertEqual(config.news_event_sentinel_active_windows, "08:00-23:59")
